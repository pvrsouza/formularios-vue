  ...
  <div id="app">
    ...
    <div class="conteudo">
      ...
      <div class="painel">
        ...
        <Rotulo nome="Mensagem">
          <!-- white-space: pre; - Preserva os espacos em branco -->
          <span style="white-space: pre;">{{mensagem}}</span>
        </Rotulo>
        <Rotulo nome="Marque as Opções">
          <span>
            <ul>
              <li v-for="(c,i) in caracteristicas" :key="i">{{c}}</li>
            </ul>
          </span>
        </Rotulo>
        <Rotulo nome="Qual produto?">
        ...
        <Rotulo nome="Prioridade">
          <span>{{prioridade}} - {{getNomePrioridade}}</span>
        </Rotulo>
        <Rotulo nome="Primeira Reclamação?">
          <span>{{escolha}}</span>
        </Rotulo>
...
export default {
  ...
  computed: {
    getNomePrioridade() {
      const pri = this.prioridades.find(p => p.codigo === this.prioridade);
      return pri.nome || "";
    }
  }
};
